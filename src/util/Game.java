...
public class Game {
        ...
        if (currentState == State.PLAYING) {
            ...
            if (currentPlayer == Seed.X) {
                while (checking) {
                    ...
                    input = playerInput.nextLine().toLowerCase();
    ...
    public static void main(String[] args) {
        ...
        while (moreGames == true) {
            ...
            String againPlay = playAgain.nextLine().toLowerCase();
            if (againPlay.equals("yes")) {
                Game anotherGame = newGame.newGameMaker();
                anotherGame.initiateGame(anotherGame);
            }
            else {
                moreGames = false;
            }
